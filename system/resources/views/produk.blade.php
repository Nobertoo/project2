    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><strong><i class="icon fa fa-user"></i> Meramput Shop</strong></a>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-desktop"></i>Produk</a>
                    </li> 
           ...
           <li>
                    ...
                    <li>
                        <a href="./promo"><i class="fa fa-qrcode"></i>Promo</a>
                    </li>
                    
                    <li>
                        <a href="./suplier"><i class="fa fa-table"></i>Suplier</a>
                    </li>
                </ul>
    ...
    <div id="page-wrapper">
      <div class="header"> 
                        <h1 class="page-header">
                            Produk <small>Welcome To Meramput Admin</small>
                        </h1>
